...
grow_to_whom <- read.csv("C:/Users/Farkas/Documents/Exploring-individual-and-demographic-factors-potentially-affecting-dogs-vocal-behaviour/Exploring_Dogs_Vocal_Behaviour_Analysis/MCA_R/data/raw/grow_to_whom.csv")
howl_on_sound <- read.csv("C:/Users/Farkas/Documents/Exploring-individual-and-demographic-factors-potentially-affecting-dogs-vocal-behaviour/Exploring_Dogs_Vocal_Behaviour_Analysis/MCA_R/data/raw/howl_on_sound.csv")
keep <- read.csv("C:/Users/Farkas/Documents/Exploring-individual-and-demographic-factors-potentially-affecting-dogs-vocal-behaviour/Exploring_Dogs_Vocal_Behaviour_Analysis/MCA_R/data/raw/keep.csv")
problems <- read.csv("C:/Users/Farkas/Documents/Exploring-individual-and-demographic-factors-potentially-affecting-dogs-vocal-behaviour/Exploring_Dogs_Vocal_Behaviour_Analysis/MCA_R/data/raw/problems.csv")
...
# Print summaries
print_mca_summary(grow_mca$mca, "Growling Behavior")
print_mca_summary(howl_mca$mca, "Howling Behavior")
print_mca_summary(keep_mca$mca, "Keeping Conditions")
print_mca_summary(problems_mca$mca, "Behavioral Problems")

...
# Select numerical columns for analysis (excluding ID and categorical variables)
...
hopkins_result <- hopkins(scale(numerical_data), m = floor(nrow(numerical_data)/10))

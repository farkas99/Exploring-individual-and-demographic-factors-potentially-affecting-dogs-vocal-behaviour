...
print(paste("Hopkins statistic (clustering tendency):", hopkins_stat$hopkins_stat))
...
library(corrplot)
corrplot(cor_matrix, method = "color", type = "upper", order = "hclust", tl.cex = 0.7, tl.col = "black", addCoef.col = "black")

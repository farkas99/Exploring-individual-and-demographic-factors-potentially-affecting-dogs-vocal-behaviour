...
# Explore each dataset with full paths
keep_data <- explore_data(file.path(base_dir, "data", "raw", "keep.csv"), "keep.csv")
howl_data <- explore_data(file.path(base_dir, "data", "raw", "howl_on_sound.csv"), "howl_on_sound.csv")
growl_data <- explore_data(file.path(base_dir, "data", "raw", "grow_to_whom.csv"), "grow_to_whom.csv")
problems_data <- explore_data(file.path(base_dir, "data", "raw", "problems.csv"), "problems.csv")
...
save(keep_data, howl_data, growl_data, problems_data, 
     file = file.path(base_dir, "results", "explored_data.RData"))

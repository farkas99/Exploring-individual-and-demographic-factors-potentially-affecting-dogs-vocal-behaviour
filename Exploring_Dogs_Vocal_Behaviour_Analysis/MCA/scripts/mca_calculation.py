...
def save_mca_results(filepath, df, mca, mca_results):
    ...
    contributions_dict = {
        ...
        'point_contributions': {}  # New field for point-level contributions
    }
    
    # Calculate point-level contributions for scatter plot
    for col in contributions.columns:
        contributions_dict['point_contributions'][col] = contributions[col].tolist()
